...
const Home = () => {
    ...
    const handleListYourRoomClick = () => {
        ...
        if (currentUser?.userType !== 'Landlord') {
            toast.error('Only landlords can list rooms. Please update your profile type.');
            return;
        }
        navigate('/post-ad');
    };
    ...
    return (
        <div className="home-spareroom">
            ...
            <div className="post-ad-cta-spareroom section-padding-spareroom bg-lightgrey-spareroom">
                ...
                <Button variant="primary" size="lg" onClick={handleListYourRoomClick} className="list-your-room-hero-btn">
                    Post Your Ad FREE
                </Button>
            </div>
        </div>
